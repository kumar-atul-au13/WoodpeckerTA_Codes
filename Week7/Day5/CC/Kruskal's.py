# Video - https://drive.google.com/file/d/1AoJXXCwD9hcsgJ6GsiKtn1wnc2JVUR0Y/view?usp=sharing
graph={
  'A':{'D':1,'B':3},
  'B':{'A':3,'C':1,'D':3},
  'C':{'B':1,'D':1,'E':5,'F':4},
...
# print(get)
# EDGE FORMAT x = ('a','b',3)  weight=x[3] starting_vertex = x[0] ending_vertex = x[1]
def kruskal(graph):
  answer_edge=[]
